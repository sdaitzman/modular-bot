...
int maxSpeed = 1023; // till 0X3FF Max speed of movement 0 to 1023
...
public void keyPressed()
{
  if (key == 'w')
  {
    servo.setMovingSpeed(1, 1022);
    servo.setMovingSpeed(2, 2047);
  } else if (key == 'a')
  {
    servo.setMovingSpeed(1, 2047);
    servo.setMovingSpeed(2, 2047);
  } else if (key == 's')
  {
    servo.setMovingSpeed(1, 2047);
    servo.setMovingSpeed(2, 1022);
  } else if (key == 'd')
  {
    servo.setMovingSpeed(1, 1022);
    servo.setMovingSpeed(2, 1022);
